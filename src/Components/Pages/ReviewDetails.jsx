...
const ReviewDetails = () => {
  ...
  return (
<div className="p-16 bg-[#e3ebeb] dark:bg-[#071523] ">
<div className="max-w-3xl mt-20 mx-auto p-6 bg-base-100 dark:bg-gray-800 shadow-lg rounded-lg animate__animated animate__fadeInUp cursor-pointer">
      <img
