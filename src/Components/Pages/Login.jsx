  ...
  return (
    <div className="bg-gradient-to-br from-[#e3ebeb] via-[#f0f6f6] to-[#e3ebeb] dark:bg-gradient-to-br dark:from-[#071523] dark:via-[#0a1a2a] dark:to-[#071523] min-h-screen">
      <div className="flex min-h-screen">
         ...
         <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-8 py-2 lg:pt-16">
           <div className="max-w-md">
            <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-[#00ADB5] to-[#008C8C] bg-clip-text text-transparent">
              <Typewriter
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed">
              Your ultimate destination for game reviews and gaming insights. Join our community of passionate gamers and discover your next favorite game.
            </p>
            
            {/* Stats Cards */}
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/10 dark:bg-gray-800/20 backdrop-blur-sm rounded-xl border border-[#00ADB5]/20 p-6">
                <div className="text-3xl font-bold text-[#00ADB5] mb-2">10K+</div>
                <div className="text-gray-600 dark:text-gray-400 font-medium">Active Gamers</div>
              </div>
              <div className="bg-white/10 dark:bg-gray-800/20 backdrop-blur-sm rounded-xl border border-[#00ADB5]/20 p-6">
                <div className="text-3xl font-bold text-[#00ADB5] mb-2">50K+</div>
                <div className="text-gray-600 dark:text-gray-400 font-medium">Reviews Shared</div>
              </div>
            </div>
          </div>
        </div>
         ...
         <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-2 lg:pt-16">
